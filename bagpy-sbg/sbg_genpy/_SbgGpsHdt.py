...
class SbgGpsHdt(genpy.Message):
  _md5sum = "e132ccfa1c1c41e27b0c5998a0ca02cd"
...
string frame_id
"""
  __slots__ = ['header','time_stamp','status','tow','true_heading','true_heading_acc','pitch','pitch_acc']
  _slot_types = ['std_msgs/Header','uint32','uint16','uint32','float32','float32','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,time_stamp,status,tow,true_heading,true_heading_acc,pitch,pitch_acc
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_IHI4f().pack(_x.time_stamp, _x.status, _x.tow, _x.true_heading, _x.true_heading_acc, _x.pitch, _x.pitch_acc))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.time_stamp, _x.status, _x.tow, _x.true_heading, _x.true_heading_acc, _x.pitch, _x.pitch_acc,) = _get_struct_IHI4f().unpack(str[start:end])
      return self
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_IHI4f = None
def _get_struct_IHI4f():
    global _struct_IHI4f
    if _struct_IHI4f is None:
        _struct_IHI4f = struct.Struct("<IHI4f")
    return _struct_IHI4f
